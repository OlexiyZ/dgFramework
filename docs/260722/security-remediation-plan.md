...
**Дії на стороні DevOps** (ротація секретів, env-змінні, ingress, апрув CI) зібрані
окремо: [devops-handover.md](devops-handover.md). Там же — чеклист перевірки після
деплою і план відкату.
